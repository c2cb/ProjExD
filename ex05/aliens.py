...
# game constants
MAX_SHOTS = 20     #2 most player bullets onscreen
ALIEN_ODDS = 2     #22 chances a new alien appears
BOMB_ODDS = 60     #60 chances a new bomb will drop
ALIEN_RELOAD = 12  #12 frames between new aliens
